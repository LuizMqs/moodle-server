...
# # Baixa o Moodle se ainda não existir
# RUN if [ ! -d /var/www/html/moodle ]; then \
#     mkdir -p /var/www/html && \
#     cd /var/www/html && \
#     git clone -b MOODLE_404_STABLE https://github.com/moodle/moodle.git moodle && \
#     chown -R nobody:nobody /var/www/html/moodle && \
...
# Garante o Moodle
RUN mkdir -p /var/www/html && \
    git clone -b MOODLE_404_STABLE https://github.com/moodle/moodle.git /var/www/html/moodle && \
